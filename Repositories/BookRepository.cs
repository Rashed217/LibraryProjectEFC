...
namespace LibraryEFC.Repositories
{
    public class BookRepository
    {
        ...
        {
            return _context.Books.FirstOrDefault(b => b.Name.Equals(name, StringComparison.OrdinalIgnoreCase));
        }
        ...
        public void Insert(Book book)
        {
            ...
            UpdateCategoryBookCount(book.CategoryId);
        }
        ...
        {
            var category = _context.Categories.FirstOrDefault(c => c.Name.Equals(name, StringComparison.OrdinalIgnoreCase));
            return category != null ? _context.Books.Count(b => b.CategoryId == category.Id) : 0;
        }
        ...
        private void UpdateCategoryBookCount(int categoryId)
        {
            ...
            if (category != null)
            {
                category.NumberOfBooks = _context.Books.Count(b => b.CategoryId == categoryId);
                _context.SaveChanges();
            }
        }
    }
